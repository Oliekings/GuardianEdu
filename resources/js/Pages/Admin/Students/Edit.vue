...
const form = useForm({
    ...
    fee_group_id: props.student.fee_group_id || '',
    rfid_token: props.student.rfid_token || '',
    ...
    category: props.student.category || 'General',
    ...
    // Guardian
    guardian_is: props.student.guardian_is || 'father',
    ...
    parent_ids: props.student.parents.map((p: any) => p.id),
});
    ...
    <AuthenticatedLayout>
        <template #header>
            <div class="flex items-center justify-between">
                <div>
                    <h2 class="text-3xl font-black text-white">Edit <span class="g-gradient-text">Profile</span></h2>
                    <p class="mt-1 text-sm text-gray-400 font-mono tracking-tighter">{{ student.full_name }} ({{ student.admission_number }})</p>
                </div>
            ...
            <div class="mx-auto max-w-5xl">
                ...
                <form @submit.prevent="submit" class="space-y-8">
                    ...
                    <div v-show="activeTab === 'academic'" class="g-card p-10 space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                            <div>
                                ...
                                <input v-model="form.admission_number" class="g-input" />
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <input v-model="form.room_id" class="g-input" />
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <input v-model="form.rfid_token" class="g-input" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div v-show="activeTab === 'bio'" class="g-card p-10 space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                            <div><label class="g-label">First Name *</label><input v-model="form.first_name" class="g-input" /></div>
                            <div><label class="g-label">Last Name *</label><input v-model="form.last_name" class="g-input" /></div>
                            <div><label class="g-label">Email Address</label><input type="email" v-model="form.email" class="g-input" /></div>
                            <div><label class="g-label">Phone Number</label><input v-model="form.phone" class="g-input" /></div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 pt-4 border-t border-white/5">
                            ...
                            <div><label class="g-label text-[10px]">Religion</label><input v-model="form.religion" class="g-input" /></div>
                            <div><label class="g-label text-[10px]">Blood Group</label><input v-model="form.blood_group" class="g-input" /></div>
                        </div>
                    </div>
                    ...
                    <div v-show="activeTab === 'parents'" class="g-card p-10 space-y-12 animate-in fade-in slide-in-from-bottom-4 duration-500">
                        <section class="space-y-6">
                            <h4 class="text-xs font-bold text-gray-500 uppercase tracking-widest flex items-center gap-2"><span class="p-1 px-2 bg-indigo-500/10 text-indigo-400 rounded">Father's Information</span></h4>
                        ...
                        <section class="space-y-6">
                            <h4 class="text-xs font-bold text-gray-500 uppercase tracking-widest flex items-center gap-2"><span class="p-1 px-2 bg-rose-500/10 text-rose-400 rounded">Mother's Information</span></h4>
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div class="flex items-center justify-between pt-8 border-t border-white/5">
                        <div class="text-[10px] text-gray-600 uppercase font-bold tracking-widest italic">Syncing changes to core database...</div>
                        <div class="flex gap-4">
                            ...
                            >
                                {{ form.processing ? 'Syncing...' : 'Save Profile' }}
                            </button>
                        </div>
                    </div>
                </form>
